		...
		/** Columns **/
		{
			...
			menu: [
				...
				/* Columns */
				{
					text: 'Two Columns',
					onclick: function() {
						editor.insertContent( '[bsc_column_wrap]<br />[bsc_column size="6"]<br />Content in column 1<br />[/bsc_column]<br />[bsc_column size="6"]<br />Content in column 2<br />[/bsc_column][/bsc_column_wrap]');
					}
				}, // End Columns
				...
				/* Columns */
				{
					text: 'Three Columns',
					onclick: function() {
						editor.insertContent( '[bsc_column_wrap]<br />[bsc_column size="4"]<br />Content in column 1<br />[/bsc_column]<br />[bsc_column size="4"]<br />Content in column 2<br />[/bsc_column]<br />[bsc_column size="4"]<br />Content in column 3<br />[/bsc_column]<br />[/bsc_column_wrap]');
					}
				}, // End Columns
