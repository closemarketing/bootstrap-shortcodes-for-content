...
class BSC_contact_ extends WP_Widget {

	function __construct() {
		$widget_ops = array('classname' => 'widget_contact', 'description' => __('Adds contact info in a widget.', 'bsc'));
		$control_ops = array('width' => 400, 'height' => 350);
		parent::__construct('contact_widget', __('Contact Info','bsc'), $widget_ops, $control_ops);
	}
		...
		echo $before_widget; ?>
			...
			<div class="companyinfo" itemscope itemtype="http://schema.org/LocalBusiness">
			  ...
			  <?php if($contact_phone) { ?>
				  ...
				  <?php _e('Phone','bsc');?>: <span itemprop="telephone"><?php echo $contact_phone; ?></span><br/>
			  <?php } ?>
...
?>
		<p>
            <label for="<?php echo $this->get_field_id('contact_company'); ?>"><?php _e('Contact Name','bsc'); ?>:</label>
		...
		<p>
            <label for="<?php echo $this->get_field_id('contact_dir1'); ?>"><?php _e('Address info 1','bsc'); ?>:</label>
		...
		<p>
            <label for="<?php echo $this->get_field_id('contact_dir2'); ?>"><?php _e('Address info 2','bsc'); ?>:</label>
		...
		<p>
            <label for="<?php echo $this->get_field_id('contact_zip'); ?>"><?php _e('ZIP','bsc'); ?>:</label>
		...
		<p>
            <label for="<?php echo $this->get_field_id('contact_city'); ?>"><?php _e('City','bsc'); ?>:</label>
		...
		<p>
            <label for="<?php echo $this->get_field_id('contact_state'); ?>"><?php _e('State','bsc'); ?>:</label>
		...
		<p>
            <label for="<?php echo $this->get_field_id('contact_phone'); ?>"><?php _e('Phone','bsc'); ?>:</label>
		...
		<p>
            <label for="<?php echo $this->get_field_id('contact_email'); ?>"><?php _e('Email','bsc'); ?>:</label>
		...
		<p>
            <label for="<?php echo $this->get_field_id('contact_desc'); ?>"><?php _e('Contact Description','bsc'); ?>:</label>
...
add_action( 'widgets_init', create_function( '', 'register_widget( "BSC_contact_" );' ) );
